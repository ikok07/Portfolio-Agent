...
from src.api.routers import clerk_auth, agent, vector_store, chatbot_sessions
...
app.include_router(chatbot_sessions.router, prefix="/chatbot-session", tags=["Chatbot Session"])
